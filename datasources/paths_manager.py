...
# MY_SAVED_MODEL = os.path.join(dirname, "../pretrained_models/ukdale/KNNweights_max20comp ukdale_1hr_16_19_08-27_05_2022.pkl")
# MY_PATH_SIGNAL2VEC = os.path.join(dirname, '../pretrained_models/ukdale/emb_max20comp ukdale_1hr_2ep_00_29_44-28_05_2022.csv')

# MY_SAVED_MODEL = os.path.join(dirname, "../KNNweights_max10red_1day01_17_47-21_06_2022.pkl")
# MY_PATH_SIGNAL2VEC = os.path.join(dirname, '../emb_max10red_1day0ep_01_27_15-21_06_2022.csv')
